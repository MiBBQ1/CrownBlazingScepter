...
import com.crownnblazingscepppter.PreferenceHelper.APPSFLYER_ID
import com.crownnblazingscepppter.PreferenceHelper.FIRST_OPEN
import com.crownnblazingscepppter.PreferenceHelper.GAME_START
import com.crownnblazingscepppter.PreferenceHelper.NAMING_SUBS
import com.crownnblazingscepppter.PreferenceHelper.STATE_ADS
import com.crownnblazingscepppter.PreferenceHelper.URL_LINK
...
class MainActivity : AppCompatActivity(), CoroutineScope {
    ...
    fun shareWithFriends(view: View) {
        val shareIntent = Intent(Intent.ACTION_SEND)
        val link = "https://play.google.com/store/apps/details?id=$packageName"
        shareIntent.type = "text/plain"
        val message = "Check out this interesting application game! \n$link"
        shareIntent.putExtra(Intent.EXTRA_TEXT, message)
        startActivity(Intent.createChooser(shareIntent, "Share with colleages"))
